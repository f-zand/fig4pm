...
def k_gram_distance_all_variants(log, k, distance_measure):
    ...
    progress = tqdm(total=no_trace, leave=False, desc="K_gram distance all variants, completed :: ")
...
def k_gram_distance_all_cases(log, k, distance_measure):
    ...
    progress = tqdm(total=no_trace, leave=False, desc="K_gram distance all cases, completed :: ")
